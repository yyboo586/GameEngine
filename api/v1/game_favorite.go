...
type AddGameFavoriteReq struct {
	g.Meta `path:"/games/{id}/favorite" method:"post" tags:"Game Management/Favorite" summary:"Add Game Favorite"`
	model.Author
...
type RemoveGameFavoriteReq struct {
	g.Meta `path:"/games/{id}/favorite" method:"delete" tags:"Game Management/Favorite" summary:"Remove Game Favorite"`
	model.Author
	ID int64 `p:"id" v:"required#游戏ID不能为空" dc:"游戏ID"`
}
