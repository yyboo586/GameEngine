...
type PreUploadMediaInfoReq struct {
	g.Meta `path:"/games/{id}/media-info/pre-upload" method:"post" tags:"Game Management/Media Management" summary:"Pre Upload Game Media Info"`
	model.Author
...
type ReportUploadResult struct {
	g.Meta `mime:"application/json" path:"/games/{gameID}/media-info/upload-result" method:"post" tags:"Game Management/Media Management" summary:"Report Game Media Info Upload Result"`
	model.Author
	GameID  int64  `p:"gameID" v:"required#游戏ID不能为空" dc:"游戏ID"`
...
type PreDownloadMediaInfoReq struct {
	g.Meta `path:"/games/{gameID}/media-info/pre-download" method:"post" tags:"Game Management/Media Management" summary:"Pre Download Game Media Info"`
	model.Author
	GameID int64  `p:"gameID" v:"required#游戏ID不能为空" dc:"游戏ID"`
...
type ReportDownloadResult struct {
	g.Meta `mime:"application/json" path:"/games/{gameID}/media-info/download-result" method:"post" tags:"Game Management/Media Management" summary:"Report Game Media Info Download Result"`
	model.Author
	GameID  int64  `p:"gameID" v:"required#游戏ID不能为空" dc:"游戏ID"`
	FileID  string `json:"file_id" v:"required#文件ID不能为空" dc:"文件ID"`
...
type SaveMediaInfoReq struct {
	g.Meta `path:"/games/{game_id}/media-info/save" method:"post" tags:"Game Management/Media Management" summary:"Save Game Media Info"`
	model.Author
