...
func (c *gameController) UpdateGamePublishStatus(ctx context.Context, req *v1.UpdateGamePublishStatusReq) (res *v1.UpdateGamePublishStatusRes, err error) {
	err = service.Game().UpdateGamePublishStatus(ctx, req.ID, req.Status)
	return
}
