...
type IMetadata interface {
	...
	SearchCategory(ctx context.Context, name string) (outs []*model.Category, err error)
	...
	SearchTag(ctx context.Context, name string) (outs []*model.Tag, err error)
	...
	// 根据分类ID，检查是否有关联的游戏
	IsCategoryHasGame(ctx context.Context, categoryID int64) (bool, error)
	...
	// 根据标签ID，检查是否有关联的游戏
	IsTagHasGame(ctx context.Context, tagID int64) (bool, error)
}
