...
// UserBehaviorDao is the data access object for table t_user_behavior.
...
// UserBehaviorColumns defines and stores column names for table t_user_behavior.
...
// userBehaviorColumns holds the columns for table t_user_behavior.
